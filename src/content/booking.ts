...
export const bookingEN: BookingContent = {
  ...
  termsFee: "Sessions are €60, on a sliding scale from €40 to €80 — you choose what fits.",
  termsCancellation: "Cancel or reschedule free of charge up to 24 hours before your session.",
  termsPayment: "Payment is due after each session, by bank transfer.",
...
export const bookingRU: BookingContent = {
  ...
  termsFee: "Сессия — 60 €, по свободной шкале от 40 до 80 € — вы выбираете сумму сами.",
  termsCancellation: "Отменить или перенести сессию можно бесплатно не позднее чем за 24 часа.",
  termsPayment: "Оплата — после каждой сессии, банковским переводом.",
