...
export interface FeelingsContent {
  ...
  tally: string; deeper: string; out: string;
  previewLabel: string;
  ...
  writeDown: string;
  /** The panel before the first touch. Nothing is chosen for the reader. */
...
export const feelingsEN: FeelingsContent = {
  ...
  "intro": "Six rings, read from the outside in. The middle is the need. Touch any ring to open it, sit there as long as you like, then go a ring deeper. Any ring can be the first one, and no clock is running. If you would like a suggestion, start with the body.",
  ...
  "emptyBody": "Touch a ring on the map and it opens here.",
...
export const feelingsRU: FeelingsContent = {
  ...
  "intro": "Шесть кругов, которые читают снаружи внутрь. В середине — потребность. Коснитесь любого круга, побудьте в нём столько, сколько нужно, потом идите на круг глубже. Любой круг может быть первым, и никакого таймера здесь нет. Если нужна подсказка — начните с тела.",
  ...
  "emptyTitle": "Пока ничего не открыто",
  "emptyBody": "Коснитесь круга на карте — он откроется здесь.",
